...
func TestStreamAnthropicMessages_TextOnly(t *testing.T) {
	...
	StreamAnthropicMessages(context.Background(), map[string]interface{}{"model": "test", "messages": []interface{}{}, "stream": true}, "test", "", w)
...
func TestStreamChatCompletions_ReplacesModelAndID(t *testing.T) {
	...
	w := httptest.NewRecorder()
	StreamChatCompletions(context.Background(), map[string]interface{}{"model": "my-model", "messages": []interface{}{}, "stream": true}, "my-model", "", w)
