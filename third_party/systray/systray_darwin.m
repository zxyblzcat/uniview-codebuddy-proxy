...
- (void)applicationDidFinishLaunching:(NSNotification *)aNotification
{
  ...
  // Use native status bar menu: macOS handles positioning, appearance (vibrancy),
  // and click behavior automatically. This gives the correct translucent light/dark
  // appearance and proper positioning below the status bar.
...
- (void)show_menu
{
  // No-op: statusItem.menu is set, macOS handles menu presentation natively.
}
